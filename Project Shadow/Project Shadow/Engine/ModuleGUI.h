...
public:
	...
	Healthbar* AddHealthbar(Hero* character, Sprite* bar, bool leftSide = true, uint _x = 0, uint _y = 0, SDL_Texture* _tex = nullptr, bool _enabled = false, SDL_Rect _anim = { 0, 0, 0, 0 });
